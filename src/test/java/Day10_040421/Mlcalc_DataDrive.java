...
public class Mlcalc_DataDrive {
    public static void main(String[] args) throws IOException, InterruptedException, BiffException, WriteException {
        ...
        Workbook readableBook = Workbook.getWorkbook(new File("src/main/resources/Mlcacl_DataDrive.xls"));

//Step 2: create a writable workbook that will mimic the data from readable
        WritableWorkbook writableWorkbook = Workbook.createWorkbook(new File("src/main/resources/Mlcacl_DataDrive_Result.xls"), readableBook);
